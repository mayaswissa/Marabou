...
void OptionParser::initialize()
{
    ...
    _other.add_options()(
        ...
        "DQN-demo-examples",
        boost::program_options::value<int>( &( ( *_intOptions )[Options::DQN_NUN_DEMO_EXAMPLES] ) )
            ->default_value( ( *_intOptions )[Options::DQN_NUN_DEMO_EXAMPLES] ),
    ...
    _expert.add_options()(
        ...
        "(earliest-relu/pseudo-impact/largest-interval/relu-violation/polarity/babsr/DQN-agent)."
