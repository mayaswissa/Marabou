...
public:
    ...
    void step( unsigned currentDepth, unsigned numSplits );
    ...
    void learn( Vector<std::unique_ptr<Experience>> experiences, double gamma );
...
private:
    ...
    DelayedReplayBuffer _delayedReplayBuffer;
    unsigned _tStep;
