...
List<PiecewiseLinearCaseSplit> ReluConstraint::getRandomCaseSplits()
{
    ...
    printf("phase status : %d\n", randomDirection);
    fflush(stdout);
    if ( randomDirection == RELU_PHASE_INACTIVE )
    {
    ...
    if ( randomDirection == RELU_PHASE_ACTIVE )
    {
