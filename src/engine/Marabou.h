...
public:
    ...
    */
    ...
    trainDQNAgent( double epsilon, const std::string &exampleID, std::unique_ptr<Agent> agent );
...
private:
    ...
    */
    ...
    std::unique_ptr<Agent>
    trainQuery( double epsilon, const std::string &exampleID, std::unique_ptr<Agent> agent );
